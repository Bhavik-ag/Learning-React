...
function CounterTwo() {
    ...
    return (
        <div>
            ...
            <button onClick={() => dispatch({type : 'increament2',value : 1})}>Increament Second Count</button>
            <button onClick={() => dispatch({type : 'decreament2',value : 1})}>Decreament Second Count</button>
